...
class EmailService {
    ...
    public static function sendDonorWelcome(string $email, string $name): bool {
        ...
        $body = "
            ...
            <p><strong>Remember:</strong> You can donate whole blood every " . DONATION_COOLOFF_DAYS . " days (about 3 months). Please ensure you're well-rested and hydrated before donating.</p>
