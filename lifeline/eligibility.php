...
<div class="card maxw-700 mx-auto">
    <form id="eligibilityForm" onsubmit="return checkEligibility()">
        ...
        <button type="submit" class="btn btn-large w-full">Check My Eligibility</button>
    </form>

    <div id="eligibilityResult" class="d-none mt-24"></div>
</div>

<div class="card maxw-700 mx-auto mt-24">
    <h3 class="text-crimson mb-20">General Eligibility Guidelines</h3>
    <div class="eligibility-grid">
        <div class="guideline-col">
            <h4 class="text-success fs-100 mb-12">&#10004; You CAN donate if:</h4>
            <ul class="list-indent text-secondary fs-90 lh-16">
        ...
        <div class="guideline-col">
            <h4 class="text-danger fs-100 mb-12">&#10008; You CANNOT donate if:</h4>
            <ul class="list-indent text-secondary fs-90 lh-16">
    ...
    if (reasons.length === 0) {
        html = `
            <div class="eligibility-result eligible">
                ...
                <a href="<?php echo baseUrl(); ?>/register.php?role=donor" class="btn btn-large btn-success">
                    Register as a Donor
                </a>
            </div>
        `;
        ...
        html = `
            <div class="eligibility-result ineligible">
                ...
                <p class="text-secondary mb-16">Based on your answers, you may be deferred for the following reasons:</p>
                <ul class="text-left text-primary list-indent mb-20">
                    ${reasons.map(r => `<li class="mb-8">${r}</li>`).join('')}
                </ul>
                <p class="text-muted fs-90 italic">
